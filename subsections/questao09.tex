...
Em uma onda senoidal, a fase determina **quanto a onda está adiantada ou atrasada** no eixo do tempo.  
- \(\theta > 0\) → onda adiantada (deslocada para a esquerda)  
- \(\theta < 0\) → onda atrasada (deslocada para a direita)\par
